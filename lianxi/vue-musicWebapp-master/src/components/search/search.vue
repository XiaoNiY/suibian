<template>
    <div class="search">
        ...
        <div v-if="isShowList&&!showNotes" class="showSearch">
            <h3>最佳匹配</h3>
            <ul class="bestMatch">
                <li v-for="(list,index) in bestMatchList" v-on:click="postMusic(index)" :key="index">
        ...
        <div class="hotSearch" v-if="searchList.length">
            <h3>搜索历史</h3>
            <div v-for="item in searchList" class="searchList" v-on:click="doSearch(item)" :key="item">
                <div >{{item}}</div>
