    ...
    <div class="rankList">
        <ul>
            <li class="rankBar" v-on:click="showList(6666)">
                ...
                <div class="list"><p v-for="(item,index) in soaringList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>
            <li class="rankBar" v-on:click="showList(8888)">
                <div class="img hotList"></div>
                <div class="list"><p v-for="(item,index) in hotList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>
            <li class="rankBar" v-on:click="showList(23784)">
                <div class="img networkList"></div>
                <div class="list"><p v-for="(item,index) in networkList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>
            <li class="rankBar" v-on:click="showList(31308)">
                <div class="img newList"></div>
                <div class="list"><p v-for="(item,index) in newList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>
            <li class="rankBar" v-on:click="showList(31313)">
                <div class="img hongkongList"></div>
                <div class="list"><p v-for="(item,index) in hongkongList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>
            <li class="rankBar" v-on:click="showList(31310)">
                <div class="img westernList"></div>
                <div class="list"><p v-for="(item,index) in westernList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>

            <li class="rankBar" v-on:click="showList(31311)">
                <div class="img koreaList"></div>
                <div class="list"><p v-for="(item,index) in koreaList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>

            <li class="rankBar" v-on:click="showList(31312)">
                <div class="img japanList"></div>
                <div class="list"><p v-for="(item,index) in japanList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>
            <li class="rankBar" v-on:click="showList(30972)">
                <div class="img originalList"></div>
                <div class="list"><p v-for="(item,index) in originalList" :key="index">{{(index+1) + " " +item.filename.split("-")[1]+"-"+item.filename.split("-")[0]}}</p></div>
            </li>
        </ul>
